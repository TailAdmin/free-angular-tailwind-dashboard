...
import { TranslateModule } from '@ngx-translate/core'; // Added TranslateModule import

type NavItem = {
  name: string; // This now holds the translation key
  icon: string;
  path?: string;
  new?: boolean;
...
@Component({
  ...
  standalone: true, // Explicitly standalone for Angular 21
  imports: [
    CommonModule,
    RouterModule,
    SafeHtmlPipe,
    SidebarWidgetComponent,
    TranslateModule // Added TranslateModule to imports
  ],
  templateUrl: './app-sidebar.component.html',
})
export class AppSidebarComponent {

  // Main nav items updated with translation keys
  navItems: NavItem[] = [
    {
    ...
    },
    {
      ...
      subItems: [
        { name: "SIDEBAR.FORM_ELEMENTS", path: "/form-elements", pro: false }
      ],
    },
    {
      name: "SIDEBAR.TABLES",
      ...
      subItems: [
        { name: "SIDEBAR.BASIC_TABLES", path: "/basic-tables", pro: false },
      ],
    },
    {
      name: "SIDEBAR.PAGES",
      ...
      subItems: [
        { name: "SIDEBAR.BLANK_PAGE", path: "/blank", pro: false },
        { name: "SIDEBAR.ERROR_404", path: "/error-404", pro: false },
      ],
    },
  ];

  // Others nav items updated with translation keys
  othersItems: NavItem[] = [
    {
      ...
      name: "SIDEBAR.CHARTS",
      subItems: [
        { name: "SIDEBAR.LINE_CHART", path: "/line-chart", pro: false },
        { name: "SIDEBAR.BAR_CHART", path: "/bar-chart", pro: false },
      ],
    },
    {
      ...
      subItems: [
        { name: "SIDEBAR.ALERTS", path: "/alerts", pro: false },
        { name: "SIDEBAR.AVATAR", path: "/avatars", pro: false },
        { name: "SIDEBAR.BADGE", path: "/badge", pro: false },
        { name: "SIDEBAR.BUTTONS", path: "/buttons", pro: false },
        { name: "SIDEBAR.IMAGES", path: "/images", pro: false },
        { name: "SIDEBAR.VIDEOS", path: "/videos", pro: false },
      ],
    },
    {
      ...
      subItems: [
        { name: "SIDEBAR.SIGN_IN", path: "/signin", pro: false },
        { name: "SIDEBAR.SIGN_UP", path: "/signup", pro: false },
      ],
    },
  ];
