...
export class InvoiceListComponent {
  ...
  public products = signal<Product[]>([
    { id: 1, name: 'Brake Pad Set', sku: 'BP-001', price: 1250.00, stock: 45, toSell: 0 },
    { id: 2, name: 'Engine Oil 5L', sku: 'EO-102', price: 2800.00, stock: 12, toSell: 0 },
    { id: 3, name: 'Air Filter', sku: 'AF-552', price: 450.00, stock: 30, toSell: 0 },
  ]);
